...
# A few helper data structures
initial_votes = {category["id"]: None for category in BALLOT_DATA["items"]}

id_to_category = {
    item["id"]: category["id"]
    for category in BALLOT_DATA["items"]
    for item in category["items"]
}

category_id_to_name = {
    category["id"]: category["title"] for category in BALLOT_DATA["items"]
}
